...
/* 4. For each employee, count the number of projects he participates in, and display the results (including zero for employees working on no projects). */
...
/* 7. Find the deparment with the largest difference between the highest and lowest salary. */

/* 8. Find the ratio between the employee with the highest and lowest salary. */

/* 9. Assume that the first 2000 of an employee's salary are taxed at 20% and any amount above 2000 is taxed at 40%. How much is paid in taxes each month by individual departments? */
